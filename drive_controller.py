...
class DriveController:
    ...
    def setup_gpio(self):
        ...
        self.left_forward_pwm = gpio.PWM(self.LEFT_FORWARD_PIN, self.SPEED) 
        self.left_backward_pwm = gpio.PWM(self.LEFT_BACKWARD_PIN, self.SPEED) 
        self.right_forward_pwm = gpio.PWM(self.RIGHT_FORWARD_PIN, self.SPEED) 
        self.right_backward_pwm = gpio.PWM(self.RIGHT_BACKWARD_PIN, self.SPEED) 
    ...
    def forward(self):
        self.left_forward_pwm.ChangeDutyCycle(self.SPEED)
        self.right_forward_pwm.ChangeDutyCycle(self.SPEED)
        self.left_backward_pwm.ChangeDutyCycle(0)
        self.right_backward_pwm.ChangeDutyCycle(0)
    ...
    def backward(self):
        self.left_forward_pwm.ChangeDutyCycle(0)
        self.right_forward_pwm.ChangeDutyCycle(0)
        self.left_backward_pwm.ChangeDutyCycle(self.SPEED)
        self.right_backward_pwm.ChangeDutyCycle(self.SPEED)
